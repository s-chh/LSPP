...
class ShuffleNetV2(nn.Module):
	...
	def __init__(self, n_classes=100, n_channels=3, ratio=1):
		super().__init__()
		if ratio == 0.5:
		...
		self.pre = nn.Sequential(
			nn.Conv2d(n_channels, 24, 3, padding=1),
			nn.BatchNorm2d(24)
		)
		...
		self.fc = nn.Linear(out_channels[3], n_classes)
...
def shufflenetv2(n_classes=10, n_channels=3):
