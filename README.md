...
- For e.g., in the CIFAR10 dataset, while assigning the probability for class _Dog_,
...
- C Matrix for the CIFAR100 dataset is also available <a href="./figures/c_cifar100.jpg">here.</a> 
